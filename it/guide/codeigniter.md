...
#### 3.  Define a Controller for Firewall Panel.

We need a controller to get into Shieldon firewall controll panel, in this example, wedefine a controller named `Example`.
